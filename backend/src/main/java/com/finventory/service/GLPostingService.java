...
public class GLPostingService {
    ...
    public void postSalesInvoice(
        ...
        GLLine debitAR =
                GLLine.builder()
                        ...
                        .accountHead(
                                "ACCOUNTS_RECEIVABLE") // In real app, this would be dynamic based
                        // on Party
                        .debit(grandTotal)
    ...
    @Transactional
    @SuppressWarnings("checkstyle:ParameterNumber")
    public void postPurchaseInvoice(
            LocalDate date,
            UUID invoiceId,
            com.finventory.model.Party party,
            BigDecimal totalTaxable,
    ...
    @Transactional
    @SuppressWarnings("checkstyle:ParameterNumber")
    public void postPurchaseReturn(
            LocalDate date,
            UUID returnId,
            com.finventory.model.Party party,
            BigDecimal totalTaxable,
