...
class SalesInvoiceIntegrationTest {
    ...
    void testCreateSalesInvoice_IntraState() throws Exception {
        ...
        org.junit.jupiter.api.Assertions.assertEquals(
                1, stockLedgerRepository.count(), "Should create 1 stock ledger entry");
        org.junit.jupiter.api.Assertions.assertEquals(
                1, glTransactionRepository.count(), "Should create 1 GL transaction");
        // AR, Sales, CGST, SGST = 4 lines
        org.junit.jupiter.api.Assertions.assertEquals(
                4, glLineRepository.count(), "Should create 4 GL lines (AR, Sales, CGST, SGST)");
    }

    @Test
    void testCreateSalesInvoice_InterState() throws Exception {
        // Create Party in different state (e.g., 27 - Maharashtra)
        Party interStateParty =
                Party.builder()
