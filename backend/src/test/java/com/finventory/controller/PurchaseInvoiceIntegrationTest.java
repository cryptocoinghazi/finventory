...
class PurchaseInvoiceIntegrationTest {
  ...
  void createPurchaseInvoice_ShouldSucceed() throws Exception {
    PurchaseInvoiceLineDto lineDto = PurchaseInvoiceLineDto.builder()
    ...
    PurchaseInvoiceDto invoiceDto = PurchaseInvoiceDto.builder()
    ...
    mockMvc.perform(post("/api/purchase-invoices")
    ...
    Assertions.assertEquals(4, glLineRepository.count(), "Should create 4 GL lines (AP, Purchase, CGST, SGST)");
  }
}
